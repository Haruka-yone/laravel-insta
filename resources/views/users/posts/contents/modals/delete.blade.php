        ...
        <div class="modal-content" style="border-radius: 15px; overflow: hidden;">
            ...
            <div class="modal-body text-center" style="background-color: #F3EEEA;">
                ...
                <div class="mt-3">
                    @if ($post->images->isNotEmpty())
                        ...
                        <img src="{{ $post->images->first()->image }}" alt="Post {{ $post->id }}"
                            class="rounded shadow-sm mb-2 image-lg" style="border: 3px solid #B0A695; max-width: 100%; height: auto;">
                    @else
            ...
            <div class="modal-footer justify-content-between" style="background-color: #EBE3D5; border-top: none;">
                <button type="button" class="btn btn-sm"
                    style="background-color:#B0A695; color:#fff; border-radius: 8px;" data-bs-dismiss="modal">
                    Cancel
                </button>
